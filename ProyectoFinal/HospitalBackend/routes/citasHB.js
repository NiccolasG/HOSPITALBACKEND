...
connection.query('SELECT cm.id,cm.fecha, cm.id_paciente, pac.nombre, med.nombres, med.apellidos, med.consultorio FROM cita_medica cm, pacientes pac, medicos med WHERE cm.id_paciente = pac.cedula_paciente AND cm.id_medico= med.cedula', (error, results) => {
if (error) {
...
res.render('registro-citasHB', { layout: 'registro', pacientes: results, medicos: results2 })
}
});
}
});
